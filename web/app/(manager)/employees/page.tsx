...
export default async function EmployeesPage() {
  ...
  return (
    <main className="flex-1 space-y-6 p-6 md:p-10">
      <PageHeading description="People available for project work in your company." title="Employees" />
      <Card>
        <CardContent className="pt-0">
          {employees.length ? (
            <Table>
              <TableHeader><TableRow><TableHead>Employee</TableHead><TableHead>Department</TableHead><TableHead>Position</TableHead><TableHead>Assignments</TableHead><TableHead>Status</TableHead></TableRow></TableHeader>
              <TableBody>
