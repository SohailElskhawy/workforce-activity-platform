  ...
  return (
    <main className="flex-1 space-y-6 p-6 md:p-10">
      <PageHeader
        ...
        badge={<StatusBadge value={project.status} />}
        breadcrumbs={[
          { label: t.common.navigation.projects, href: "/projects" },
          { label: `${project.code} — ${project.name}` },
        ]}
        description={`${project.code} · ${project.clientName ?? t.managerDashboard.internalProject}`}
        title={project.name}
      />
      <Card>
        <CardHeader>
